...
export default function Header(){
    ...
    return (
        <>
        <div className='w-screen h-12 bg-neutral-900 z-[99999]'>
            <svg width="38" height="38" viewBox="0 0 384 384" fill="none" xmlns="http://www.w3.org/2000/svg" className='pt-2 ml-2 cursor-pointer' onClick={() => navigate('/')}>
